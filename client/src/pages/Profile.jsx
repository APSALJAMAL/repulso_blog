                ...
                <div className='flex justify-center items-center mt-10' >
                    ...
                    <Dropzone onDrop={acceptedFiles => handleFileSelection(acceptedFiles)}>
                        {({ getRootProps, getInputProps }) => (
                            <div {...getRootProps()}>
                                <input {...getInputProps()} />
                                <Avatar className="w-36 h-36 relative border-4 border-violet-500 shadow-lg group">
    <AvatarImage
  ...
  render={({ field }) => (
    <FormItem>
      ...
      <FormControl>
        ...
        <Textarea placeholder="Write something or include a link (e.g., https://example.com)" {...field} />
      </FormControl>
      <FormMessage />
    </FormItem>
  )}
